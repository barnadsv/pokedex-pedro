<script lang="ts">
	export let size: LoaderType['size'] = '60';
	export let unit: LoaderType['unit'] = 'px';
	export let pause: LoaderType['pause'] = false;
	export let ballTopLeft: LoaderType['ballTopLeft'] = '#FF3E00';
	export let ballTopRight: LoaderType['ballTopRight'] = '#F8B334';
	export let ballBottomLeft: LoaderType['ballBottomLeft'] = '#40B3FF';
	export let ballBottomRight: LoaderType['ballBottomRight'] = '#676778';
	export let duration: LoaderType['duration'] = '1.5s';
</script>

<div
	class="wrapper flex justify-center items-center box-border"
